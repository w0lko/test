...
public class KlientFederat
{
    ...
    private KlientAmbasador fedamb;

    private void log(String message)
    {
        System.out.println( "LOG KlientFederat: " + message );
    }
    ...
    public void runFederate( String federateName ) throws RTIexception
    {
        ...
        log( "Wyrejestrowanie z federacji" );
    ...
    private void publishAndSubscribe() throws RTIexception
    {
        ...
        int acHandle    = rtiamb.getAttributeHandle( "wiek", classHandle );
    ...
    private void updateAttributeValues( int objectHandle ) throws RTIexception
    {
        ...
        byte[] acValue = EncodingHelpers.encodeDouble(22.0);
    ...
    private void sendInteraction() throws RTIexception
    {
        ...
        int ile = random.nextInt()%100;
        byte[] xaValue = EncodingHelpers.encodeString( "" + ile );
    ...
    public static void main( String[] args )
    {
        ...
        try
        {
            new KlientFederat().runFederate( federateName );
        }
